...
class CreateDashboard(Dashboard):
	...
	print ("IM HERE FUCK")
        ...
        self.motors = [MotorWidget('/main_motor'), 
                         MotorWidget('/mobile_base/commands/motor_power'),
                         MotorWidget('/mobile_base/commands/motor_power')]
    ...
    def get_widgets(self):
        ...
        return [[MonitorDashWidget(self.context), ConsoleDashWidget(self.context), self.mode], self.motors,
...
#            elif status.name == "/Create/Safety Status":
#		print ("AQUI CARAJO")                
#               for value in status.values:
#                    safety_status[value.key]=value.value
            
            elif status.name == "/Create/Serial Status":                
                for value in status.values:
                    serial_status[value.key]=value.value

	    elif status.name == "/Create/Base Mode":
                op_mode=status.message

	    elif status.name == "/Create/Driver Status":
                driver_status=status.message
